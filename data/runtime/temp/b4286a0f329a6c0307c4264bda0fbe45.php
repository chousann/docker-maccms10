<?php if (!defined('THINK_PATH')) exit(); /*a:30:{s:35:"template/conch/html/vod/detail.html";i:1655046318;s:50:"/var/www/html/template/conch/html/public/meta.html";i:1646145371;s:50:"/var/www/html/template/conch/html/public/seos.html";i:1595336848;s:53:"/var/www/html/template/conch/html/public/include.html";i:1627651980;s:50:"/var/www/html/template/conch/html/public/head.html";i:1627644338;s:50:"/var/www/html/template/conch/html/ads/ads-top.html";i:1595406136;s:57:"/var/www/html/template/conch/html/widget/search-form.html";i:1593675890;s:51:"/var/www/html/template/conch/html/public/menus.html";i:1595573070;s:50:"/var/www/html/template/conch/html/widget/icon.html";i:1586076696;s:50:"/var/www/html/template/conch/html/ads/ads-all.html";i:1595406022;s:54:"/var/www/html/template/conch/html/widget/vod-data.html";i:1654447091;s:55:"/var/www/html/template/conch/html/widget/tool-icon.html";i:1596476744;s:52:"/var/www/html/template/conch/html/widget/scores.html";i:1592649734;s:52:"/var/www/html/template/conch/html/widget/crumbs.html";i:1594033894;s:54:"/var/www/html/template/conch/html/module/playlist.html";i:1594401602;s:49:"/var/www/html/template/conch/html/ads/ads-sw.html";i:1595406072;s:54:"/var/www/html/template/conch/html/module/downlist.html";i:1594404986;s:53:"/var/www/html/template/conch/html/module/content.html";i:1590065690;s:53:"/var/www/html/template/conch/html/module/related.html";i:1595095538;s:54:"/var/www/html/template/conch/html/widget/vod-item.html";i:1594403530;s:59:"/var/www/html/template/conch/html/widget/actor-item-sm.html";i:1593101670;s:54:"/var/www/html/template/conch/html/widget/art-item.html";i:1594064312;s:53:"/var/www/html/template/conch/html/module/comment.html";i:1594045856;s:53:"/var/www/html/template/conch/html/module/vodside.html";i:1595396182;s:51:"/var/www/html/template/conch/html/ads/ads-side.html";i:1595406120;s:50:"/var/www/html/template/conch/html/public/foot.html";i:1627652006;s:54:"/var/www/html/template/conch/html/public/footnavs.html";i:1594799406;s:54:"/var/www/html/template/conch/html/widget/iconfill.html";i:1586596582;s:53:"/var/www/html/template/conch/html/ads/ads-double.html";i:1595406110;s:53:"/var/www/html/template/conch/html/ads/ads-bottom.html";i:1595406090;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<body class="<?php if($conch['detail']['bg']['btn']==1): ?>conch-hasbg <?php endif; ?>conch-hasone">
                   ...
                   <div class="hl-sh-wrap">
                       <div class="hl-sh-item">
                            ...
                            <ul class="hl-sh-list clearfix">
                                <?php $_64218c63db8a3=explode(',',$maccms['search_hot']); if(is_array($_64218c63db8a3) || $_64218c63db8a3 instanceof \think\Collection || $_64218c63db8a3 instanceof \think\Paginator): if( count($_64218c63db8a3)==0 ) : echo "" ;else: foreach($_64218c63db8a3 as $key=>$vo): ?>
...
<div id="conch-content" class="conch-content">
    <div class="conch-ctwrap-auto">
        <div class="hl-has-item">
            <?php if($conch['detail']['bg']['btn']==1): ?>
            <div class="hl-topbg">
                <span class="hl-topbg-pic" style="background-image:url(<?php echo mac_url_img($obj['vod_pic']); ?>"></span>
...
<?php endif; endif; endif; ?>
                <div class="hl-row-box clearfix">
                    <div class="hl-col-xs-12 hl-col-md-70w hl-col-lg-9">
                        <div class="hl-detail-content<?php if(in_array($obj['type_id'], explode(',',$id1))): ?> hl-wide-items<?php endif; ?> hl-marg-right50 clearfix">
                            <div class="hl-dc-pic">
                            ...
                            <div class="hl-dc-content">
                                <div class="hl-dc-headwrap">
                                    <h2 class="hl-dc-title hl-data-menu"><?php echo $obj['vod_name']; ?></h2>
                                    <?php if($obj['vod_sub']!=''): ?><div class="hl-dc-sub"><?php echo $obj['vod_sub']; ?></div><?php endif; ?>
                                </div>
    ...
    <ul class="clearfix">
        ...
        <?php endif; ?>
                                ...
                                <div class="hl-dc-btns hl-from-buttons">
                                    ...
                                    <span class="hl-copyright-tips hl-text-muted"><i class="iconfont hl-icon-tixing"></i>&nbsp;<?php echo mac_default($GLOBALS['config']['app']['copyright_notice'],'应版权方要求！本片相关资源已关闭！'); ?></span>
                                    <?php else: if(is_array($obj['vod_play_list']) || $obj['vod_play_list'] instanceof \think\Collection || $obj['vod_play_list'] instanceof \think\Paginator): if( count($obj['vod_play_list'])==0 ) : echo "" ;else: foreach($obj['vod_play_list'] as $key=>$vo): if($key == '1'): ?>
                                    <span class="hl-play-wb">				    
                                        <a class="hl-play-btn hl-btn-gradient" href="<?php echo mac_url_vod_play($obj,['sid'=>$vo['sid'],'nid'=>1]); ?>"><i class="iconfont hl-icon-shipin"></i>&nbsp;立即播放</a>
                                    </span><?php endif; endforeach; endif; else: echo "" ;endif; if($obj['vod_play_list'] == 0 && $obj['vod_down_list'] != 0): if(is_array($obj['vod_down_list']) || $obj['vod_down_list'] instanceof \think\Collection || $obj['vod_down_list'] instanceof \think\Paginator): if( count($obj['vod_down_list'])==0 ) : echo "" ;else: foreach($obj['vod_down_list'] as $key=>$vo): if($key == '1'): ?>
                                    <span class="hl-play-wb">				    
                                        <a class="hl-play-btn hl-btn-gradient" href="<?php echo mac_url_vod_down($obj,['sid'=>$vo['sid'],'nid'=>1]); ?>"><i class="iconfont hl-icon-xiazai"></i>&nbsp;下载观看</a>
                                    ...
                                    <span class="hl-form-wb">
                                        ...
                                        <a class="hl-from-btn hl-text-muted" style="display:<?php if($key == '1'): ?>block<?php else: ?>none<?php endif; ?>" href="javascript:void(0);">
                                            <i class="iconfont hl-jiantou hl-icon-jiantouxia hl-pull-right"></i>
                                            <span class="hl-lc-1"><i class="iconfont hl-icon-laiyuan"></i>&nbsp;<?php echo $vo['player_info']['show']; ?></span>
                                        </a>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                        <div class="hl-from-wrap hl-alert-box hl-bg-site hl-fadeIn-sm hl-half-alert hl-half-y100">
                                            ...
                                            <ul class="hl-from-list">
                                                <?php if(is_array($obj['vod_play_list']) || $obj['vod_play_list'] instanceof \think\Collection || $obj['vod_play_list'] instanceof \think\Paginator): if( count($obj['vod_play_list'])==0 ) : echo "" ;else: foreach($obj['vod_play_list'] as $key=>$vo): ?>
                                                <li <?php if($key == '1'): ?>class="active" <?php endif; ?>data-href="<?php echo mac_url_vod_play($obj,['sid'=>$vo['sid'],'nid'=>1]); ?>"><i class="iconfont hl-icon-dui hl-pull-right hl-text-muted"></i><span class="hl-from-<?php echo $vo['player_info']['from']; ?> hl-lc-1"><?php echo $vo['player_info']['show']; ?></span></li>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>	
                                            </ul>
                                        </div>
                                    </span>
                    ...
                    <div class="hl-col-xs-12 hl-col-md-30w hl-col-lg-3<?php if(in_array($obj['type_id'], explode(',',$id1))): ?> hl-hidden-xs hl-hidden-sm<?php endif; ?>">
                        <div class="hl-detail-side hl-bg-site<?php if(in_array($obj['type_id'], explode(',',$id1))): ?> hl-wide-items<?php endif; ?> clearfix">
                            <?php if(!in_array($obj['type_id'], explode(',',$id1))): ?>
...
<?php endif; ?>
                <div class="hl-col-xs-12 hl-col-md-70w hl-col-lg-9">
                    <div class="hl-rb-left hl-marg-right50 clearfix">
                        <?php if($conch['detail']['play']['btn']==1): if($obj['vod_copyright'] == 1 && $GLOBALS['config']['app']['copyright_status'] == 1): else: if(!(empty($obj['vod_play_list']) || (($obj['vod_play_list'] instanceof \think\Collection || $obj['vod_play_list'] instanceof \think\Paginator ) && $obj['vod_play_list']->isEmpty()))): ?>
...
<?php endif; endif; endif; if($conch['theme']['ads']['btn']==1): if($conch['theme']['ads']['vip']==1&&$user['group_id'] > 2): else: if($conch['theme']['ads']['sw']!=''): ?>
<div id="ad1007" class="conch-ads-box hl-this-box hl-row-box clearfix">
    <a class="hl-close-this" href="javascript:void(0)"><i class="iconfont hl-icon-cuo"></i></a>
    <div class="ads ads-sw"><?php echo $conch['theme']['ads']['sw']; ?></div>
    <?php if($conch['theme']['ads']['tip']==1): ?><span class="hl-ad-tip">广告</span><?php endif; ?>
</div>
<?php endif; endif; endif; if($conch['detail']['down']['btn']==1): if($obj['vod_copyright'] == 1 && $GLOBALS['config']['app']['copyright_status'] == 1): else: if(!(empty($obj['vod_down_list']) || (($obj['vod_down_list'] instanceof \think\Collection || $obj['vod_down_list'] instanceof \think\Paginator ) && $obj['vod_down_list']->isEmpty()))): ?>
<div class="hl-row-box hl-rb-downlist hl-tabs-item clearfix" id="downlist">
    <div class="hl-rb-head clearfix">
        <h3 class="hl-rb-title">下载列表</h3>
        <a class="hl-sort-btn hl-rb-more hl-text-muted hl-pull-right" href="javascript:void(0)"><i class="iconfont hl-icon-daoxu"></i>&nbsp;<span>倒序</span></a>
    </div>
    <div class="hl-play-source hl-hidden">
         <div class="hl-plays-wrap hl-tabs-swiper">
            <div class="hl-plays-from hl-tabs swiper-wrapper clearfix">
                ...
                <a class="hl-tabs-btn hl-slide-swiper<?php if($maccms['aid']==16&&$vo['player_info']['from']==$obj['vod_down_list'][$param['sid']]['player_info']['from']): ?> active<?php elseif($maccms['aid']!=16&&$key==1): ?> active<?php endif; ?>" href="javascript:void(0);" alt="<?php echo $vo['player_info']['show']; ?>"><i class="iconfont hl-icon-xiazai"></i>&nbsp;<?php echo $vo['player_info']['show']; ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
        <script src="<?php echo $maccms['path_tpl']; ?>asset/js/parts/down.js"></script>
        <?php if(is_array($obj['vod_down_list']) || $obj['vod_down_list'] instanceof \think\Collection || $obj['vod_down_list'] instanceof \think\Paginator): if( count($obj['vod_down_list'])==0 ) : echo "" ;else: foreach($obj['vod_down_list'] as $key=>$vo): ?>
        <div class="hl-tabs-box hl-fadeIn" style="display: <?php if($maccms['aid']==16&&$vo['player_info']['from']==$obj['vod_down_list'][$param['sid']]['player_info']['from']): ?>block<?php elseif($maccms['aid']!=16&&$key==1): ?>block<?php else: ?>none<?php endif; ?>;">
            <div class="hl-list-wrap">
                <div class="conch-scrollbar hl-downs-scrollbar" style="max-height: 216px;overflow: hidden;position: relative;">
                    <div class="swiper-wrapper">
                        <ul class="swiper-slide hl-downs-list hl-sort-list clearfix" id="hl-downs-list" style="height: auto;">
                            <?php if(is_array($vo['urls']) || $vo['urls'] instanceof \think\Collection || $vo['urls'] instanceof \think\Paginator): if( count($vo['urls'])==0 ) : echo "" ;else: foreach($vo['urls'] as $key2=>$vo2): ?>
                            <li<?php if($param['sid']==$vo['sid']&&$param['nid']==$vo2['nid']): ?> class="active"<?php endif; ?>>
                                <div class="hl-downs-box">
                                    <span class="text hl-lc-1">
                                        <input type="checkbox" name="down_url_list_<?php echo $key; ?>" class="conch-input down_url" value="<?php echo $vo2['url']; ?>" file_name="<?php echo $vo2['name']; ?>"/>
                                        <a class="down-name" href="<?php echo mac_url_vod_down($obj,['sid'=>$vo['sid'],'nid'=>$vo2['nid']]); ?>"><em class="filename"><?php echo $vo2['name']; ?></em><em class="filesize"></em></a>
                                    </span>
                                    <input type="text" class="url-input hl-bg-subs hl-text-muted hl-hidden-xs hl-lc-1" value="<?php echo $vo2['url']; ?>" onclick="this.select()"/>
                                    <span class="btns">
                                        <a class="hl-text-white thunder_down down-xl" href="javascript:void(0)">迅雷下载</xiaomi>
                                        <a class="hl-text-white xiaomi down-xm hl-hidden-xs" href="javascript:void(0)">小米路由</xiaomi>
                                        <a class="hl-text-white down-url hl-hidden-xs" href="<?php echo $vo2['url']; ?>">本地下载</a>
                                        <a class="hl-text-white down-copy conch-copy" href="javascript:void(0)" data-clipboard-action="copy" data-clipboard-text="<?php echo $vo2['url']; ?>">复制链接</a>
                                    </span>
                                </div>
                            </li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <div class="hl-downs-tools">
                    <input id="allcheck<?php echo $key; ?>" class="conch-input" type="checkbox" name="checkall"><em>全选</em><a rel="nofollow" href="javascript:void(0);" target="_self" class="thunder_down_all">迅雷批量下载</a>
                    <span class="tips hl-hide-sm"><em class="hl-text-muted">没有迅雷？点击</em><a rel="nofollow" href="https://dl.xunlei.com/" target="_blank">下载 &gt;</a></span>
                    <span class="tips hl-hidden-xs"><em class="hl-text-muted">没有安装迅雷？点击</em><a rel="nofollow" href="https://dl.xunlei.com/" target="_blank">这里下载最新版迅雷 &gt;</a></span>
                </div>
                <div class="hl-downs-tips hl-bg-subs hl-text-subs">
                    下载帮助：<span class="hl-text-muted"><?php echo $vo['player_info']['tip']; ?></span>
                </div>
            </div>
        </div>
        <?php endforeach; endif; else: echo "" ;endif; ?>
...
<?php endif; endif; endif; if($conch['detail']['content']['btn']==1): if($obj['vod_content'] != ''): ?>
<div class="hl-row-box hl-rb-content clearfix">
    <div class="hl-rb-head clearfix">
        <h3 class="hl-rb-title">剧情简介</h3>
    </div>
    <div class="hl-content-wrap hl-content-hide">
        <span class="hl-content-text"><em><?php echo mac_filter_html($obj['vod_content']); ?></em></span>
...
<?php endif; endif; if($maccms['mid']==1): $id1=$conch['theme']['svideo']['id'];$id2=$conch['theme']['cover']['wide'];$id=$id1.','.$id2; if($maccms['aid']!=15&&$obj['vod_rel_vod']!=''&&$conch['theme']['relvod']['btn']==1): ?>
...
<div class="hl-row-box hl-rb-rank clearfix">
    ...
    <?php if($GLOBALS['config']['app']['copyright_status'] == 2): ?>
    <script>
