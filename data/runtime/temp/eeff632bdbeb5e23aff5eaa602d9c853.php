                   ...
                   <div class="hl-sh-wrap">
                       <div class="hl-sh-item">
                            ...
                            <ul class="hl-sh-list clearfix">
                                <?php $_642196d5d89d1=explode(',',$maccms['search_hot']); if(is_array($_642196d5d89d1) || $_642196d5d89d1 instanceof \think\Collection || $_642196d5d89d1 instanceof \think\Paginator): if( count($_642196d5d89d1)==0 ) : echo "" ;else: foreach($_642196d5d89d1 as $key=>$vo): ?>
...
<div class="conch-ctwrap">
    ...
    <div class="hl-reg-wrap">
        <form class="hl-reg-form" method="post" id="fm" action="">
            ...
            <div class="hl-reg-group">
                <label>验证码</label><input type="text" class="hl-reg-control hl-reg-w2" id="verify" name="verify" placeholder="输入验证码"><img class="hl-reg-w3" id="verify_img" src="<?php echo url('verify/index'); ?>" onClick="this.src=this.src+'?'"  alt="单击刷新" />
            </div>
            <?php endif; ?>
        ...
        <div class="hl-reg-other hl-text-center clearfix">
            ...
            <div class="hl-reg-oauth">
                ...
                <a class="hl-reg-wx" href="<?php echo url('user/oauth'); ?>?type=weixin"><i class="iconfont hl-icon-weixin"></i></a>
                <?php endif; if($GLOBALS['config']['connect']['qq']['status'] == 1): ?>
                <a class="hl-reg-qq" href="<?php echo url('user/oauth'); ?>?type=qq"><i class="iconfont hl-icon-qq"></i></a>
                <?php endif; ?>
            </div>
        </div>
        <?php endif; ?>
